...
public class Extenso {
    ...
    private String Qualificadores[][] = { { "centavo", "centavos" },
            ...
            { "sextilhao", "sextilhoes" }, { "septilhao", "septilhoes" } };
    ...
    public static void main(String[] args) throws NumberFormatException {
        ...
        System.out. println("Digite o valor numerico para ver sua forma por extensa: ");
        double valor = sc.nextDouble();

        // Converte do tipo BigDecimal para a String por extenso.
        Extenso teste = new Extenso(new BigDecimal(valor));
